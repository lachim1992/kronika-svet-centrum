...
const STRUCTURE_LABELS: Record<string, Record<string, { label: string; desc: string }>> = {
  urban_style: {
    organic: { label: "🏘️ Organický", desc: "−15% náklady, −10% doba stavby. Méně bydlení." },
    planned: { label: "🏛️ Plánovaný", desc: "+10% obilí, +10% bohatství, +15% bydlení, +3 stabilita. Dražší stavby." },
    fortified: { label: "🏰 Opevněný", desc: "+15 obrana, +15% kámen, +5 obléhání. Stavby o 20% dražší." },
    scattered: { label: "🏕️ Rozptýlený", desc: "−30% náklady, −25% doba stavby, +0.5% růst. −10 obrana." },
    coastal: { label: "⚓ Pobřežní", desc: "+20% bohatství, +5% obilí, +10% bydlení. −10% dřevo." },
    underground: { label: "⛏️ Podzemní", desc: "+20 obrana, +25% kámen, +15% železo. −15% obilí, méně bydlení." },
  },
  society_structure: {
    tribal: { label: "🏕️ Kmenová", desc: "−30% rychlost mobilizace, +3 morálka. −3 stabilita." },
    hierarchical: { label: "👑 Hierarchická", desc: "+5 stabilita, +2 legitimita/kolo, −10% doba stavby. Pomalejší růst." },
    egalitarian: { label: "⚖️ Rovnostářská", desc: "+3 stabilita, +0.5% růst, +5% měšťanů. Pomalejší mobilizace." },
    theocratic: { label: "⛪ Teokratická", desc: "+8% duchovních, +3 legitimita, +4 stabilita. −10% bohatství." },
    feudal: { label: "🏰 Feudální", desc: "+8 obrana, −15% mobilizace, +2 stabilita. Méně měšťanů." },
    mercantile: { label: "💰 Obchodnická", desc: "+25% bohatství, +10% měšťanů. −5 obrana, pomalejší nábor." },
  },
  military_doctrine: {
    defensive: { label: "🛡️ Obranná", desc: "+12 obrana, −10% doba stavby. −5 obléhání." },
    offensive: { label: "⚔️ Útočná", desc: "+5 morálka, +8 obléhání, −10% mobilizace. −5 obrana." },
    guerrilla: { label: "🌿 Partyzánská", desc: "+3 morálka, +5 obrana, −20% mobilizace. Levnější stavby." },
    naval: { label: "⚓ Námořní", desc: "+10% bohatství, +3 obrana, +10% dřevo." },
    mercenary: { label: "💰 Žoldnéřská", desc: "−25% mobilizace, +5% bohatství. −2 morálka." },
    conscript: { label: "📋 Branná povinnost", desc: "−40% mobilizace. −3 morálka, −0.3% růst, −5% obilí." },
  },
  economic_focus: {
    agrarian: { label: "🌾 Agrární", desc: "+20% obilí, +0.5% růst, +2 stabilita. −10% bohatství." },
    trade: { label: "🤝 Obchodní", desc: "+30% bohatství, +5% měšťanů. −10% obilí, −2 stabilita." },
    mining: { label: "⛏️ Těžařská", desc: "+20% kámen, +20% železo, −10% náklady. −10% obilí." },
    crafting: { label: "🔨 Řemeslná", desc: "−20% náklady, −15% doba stavby, +10% bohatství." },
    raiding: { label: "🏴 Nájezdnická", desc: "+4 morálka, −20% mobilizace. −5 stabilita, −15% bohatství." },
    mixed: { label: "⚖️ Smíšená", desc: "+2 stabilita, +5% obilí, +5% bohatství. Bez extrémů." },
  },
};
