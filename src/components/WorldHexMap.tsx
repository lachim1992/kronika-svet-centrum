    ...
    >
      ...
      <svg width="100%" height="100%" viewBox={`0 0 ${svgW} ${svgH}`} preserveAspectRatio="xMidYMid meet">
        ...
        <g transform={`translate(${pan.x / zoom}, ${pan.y / zoom}) scale(${zoom})`}>
          ...
          {/* Route corridors background lines — rendered under hex tiles */}
          <RouteCorridorsOverlay key={routeRefreshKey} sessionId={sessionId} offsetX={offsetX} offsetY={offsetY} interactive={false} />
          {renderCoords.map(c => {
          ...
          {/* Route corridors interactive layer — on top of hex tiles for hover/click */}
          <RouteCorridorsOverlay key={`int-${routeRefreshKey}`} sessionId={sessionId} offsetX={offsetX} offsetY={offsetY} interactive={true} />
