...
export const GOODS: CatalogGood[] = [
  ...
  { key: 'raw_rice', basket: 'staple_food', stage: 'raw', finalUse: true, household: false },
  ...
  { key: 'metalwork_tools', basket: 'tools', stage: 'final', finalUse: true, household: false },
...
export const RECIPES: CatalogRecipe[] = [
  ...
  r('harvest_rice', 'source', ['farming'], 'raw_rice', 3),
  ...
  // gathering/extraction without inputs is a SOURCE too
  r('cut_peat', 'source', ['gathering'], 'peat', 2),
  r('draw_water', 'source', ['farming'], 'well_water', 4),
...
export const PRODUCTION_BUILDINGS: BuildingContract[] = [
  ...
  { name: 'Farma', category: 'economic', roles: ['source'], tags: ['farming', 'herding'],
    levels: [['harvest_wheat', 'harvest_barley', 'herd_cattle'], ['harvest_flax', 'herd_sheep'], ['skin_cattle', 'harvest_olives']] },
  { name: 'Rýžoviště', category: 'economic', roles: ['source'], tags: ['farming'], requiresWater: true,
    levels: [['harvest_rice'], [], []] },
  ...
  { name: 'Rašeliniště', category: 'economic', roles: ['source'], tags: ['gathering'],
    levels: [['cut_peat'], ['gather_incense'], []] },
  { name: 'Studna', category: 'infrastructure', roles: ['source'], tags: ['farming'],
    levels: [['draw_water'], [], []] },
  { name: 'Akvadukt', category: 'infrastructure', roles: ['source'], tags: ['farming'],
    levels: [['draw_water'], [], []] },
  // processing
